...
--> statement-breakpoint
ALTER TABLE "api_key_folders"
ADD CONSTRAINT "api_key_folders_team_id_teams_id_fk" FOREIGN KEY ("team_id") REFERENCES "public"."teams" ("id") ON DELETE cascade ON UPDATE no action;
--> statement-breakpoint
ALTER TABLE "api_keys"
ADD CONSTRAINT "api_keys_user_id_team_users_id_fk" FOREIGN KEY ("user_id") REFERENCES "public"."team_users" ("id") ON DELETE cascade ON UPDATE no action;
--> statement-breakpoint
ALTER TABLE "api_keys"
ADD CONSTRAINT "api_keys_team_id_teams_id_fk" FOREIGN KEY ("team_id") REFERENCES "public"."teams" ("id") ON DELETE cascade ON UPDATE no action;
--> statement-breakpoint
ALTER TABLE "api_keys"
ADD CONSTRAINT "api_keys_folder_id_api_key_folders_id_fk" FOREIGN KEY ("folder_id") REFERENCES "public"."api_key_folders" ("id") ON DELETE set null ON UPDATE no action;
--> statement-breakpoint
ALTER TABLE "api_keys_to_models"
ADD CONSTRAINT "api_keys_to_models_api_key_id_api_keys_id_fk" FOREIGN KEY ("api_key_id") REFERENCES "public"."api_keys" ("id") ON DELETE cascade ON UPDATE no action;
--> statement-breakpoint
ALTER TABLE "api_keys_to_models"
ADD CONSTRAINT "api_keys_to_models_model_id_models_id_fk" FOREIGN KEY ("model_id") REFERENCES "public"."models" ("id") ON DELETE cascade ON UPDATE no action;
--> statement-breakpoint
ALTER TABLE "invitations"
ADD CONSTRAINT "invitations_user_id_users_id_fk" FOREIGN KEY ("user_id") REFERENCES "public"."users" ("id") ON DELETE cascade ON UPDATE no action;
--> statement-breakpoint
ALTER TABLE "invitations"
ADD CONSTRAINT "invitations_invite_user_id_users_id_fk" FOREIGN KEY ("invite_user_id") REFERENCES "public"."users" ("id") ON DELETE cascade ON UPDATE no action;
--> statement-breakpoint
ALTER TABLE "models_to_ai_providers"
ADD CONSTRAINT "models_to_ai_providers_model_id_models_id_fk" FOREIGN KEY ("model_id") REFERENCES "public"."models" ("id") ON DELETE cascade ON UPDATE no action;
--> statement-breakpoint
ALTER TABLE "models_to_ai_providers"
ADD CONSTRAINT "models_to_ai_providers_ai_provider_id_ai_providers_id_fk" FOREIGN KEY ("ai_provider_id") REFERENCES "public"."ai_providers" ("id") ON DELETE cascade ON UPDATE no action;
--> statement-breakpoint
ALTER TABLE "orders"
ADD CONSTRAINT "orders_user_id_team_users_id_fk" FOREIGN KEY ("user_id") REFERENCES "public"."team_users" ("id") ON DELETE cascade ON UPDATE no action;
--> statement-breakpoint
ALTER TABLE "orders"
ADD CONSTRAINT "orders_team_id_teams_id_fk" FOREIGN KEY ("team_id") REFERENCES "public"."teams" ("id") ON DELETE cascade ON UPDATE no action;
--> statement-breakpoint
ALTER TABLE "sessions"
ADD CONSTRAINT "sessions_team_id_teams_id_fk" FOREIGN KEY ("team_id") REFERENCES "public"."teams" ("id") ON DELETE cascade ON UPDATE no action;
--> statement-breakpoint
ALTER TABLE "sessions"
...
--> statement-breakpoint
ALTER TABLE "team_monthly_usages"
ADD CONSTRAINT "team_monthly_usages_team_id_teams_id_fk" FOREIGN KEY ("team_id") REFERENCES "public"."teams" ("id") ON DELETE cascade ON UPDATE no action;
--> statement-breakpoint
ALTER TABLE "team_users"
ADD CONSTRAINT "team_users_team_id_teams_id_fk" FOREIGN KEY ("team_id") REFERENCES "public"."teams" ("id") ON DELETE cascade ON UPDATE no action;
--> statement-breakpoint
ALTER TABLE "team_users"
ADD CONSTRAINT "team_users_user_id_users_id_fk" FOREIGN KEY ("user_id") REFERENCES "public"."users" ("id") ON DELETE cascade ON UPDATE no action;
--> statement-breakpoint
ALTER TABLE "usages"
ADD CONSTRAINT "usages_team_id_teams_id_fk" FOREIGN KEY ("team_id") REFERENCES "public"."teams" ("id") ON DELETE cascade ON UPDATE no action;
--> statement-breakpoint
ALTER TABLE "user_configs"
ADD CONSTRAINT "user_configs_user_id_users_id_fk" FOREIGN KEY ("user_id") REFERENCES "public"."users" ("id") ON DELETE cascade ON UPDATE no action;
--> statement-breakpoint
...
--> statement-breakpoint
CREATE INDEX "api_key_folders_team_id_index" ON "api_key_folders" USING btree ("team_id");
--> statement-breakpoint
CREATE UNIQUE INDEX "api_key_folders_team_default_unique" ON "api_key_folders" USING btree ("team_id")
WHERE
    "api_key_folders"."is_default" = true;
--> statement-breakpoint
CREATE INDEX "api_keys_status_index" ON "api_keys" USING btree ("status");
--> statement-breakpoint
CREATE INDEX "api_keys_hash_index" ON "api_keys" USING btree ("api_key_hash");
--> statement-breakpoint
CREATE INDEX "api_keys_team_id_index" ON "api_keys" USING btree ("team_id");
--> statement-breakpoint
CREATE INDEX "models_owned_by_index" ON "models" USING btree ("owned_by");
--> statement-breakpoint
CREATE INDEX "models_type_index" ON "models" USING btree ("type");
--> statement-breakpoint
CREATE INDEX "models_is_public_index" ON "models" USING btree ("is_public");
--> statement-breakpoint
CREATE INDEX "models_to_ai_providers_model_id_index" ON "models_to_ai_providers" USING btree ("model_id");
--> statement-breakpoint
CREATE INDEX "orders_status_index" ON "orders" USING btree ("status");
--> statement-breakpoint
CREATE INDEX "orders_usage_status_index" ON "orders" USING btree ("usage_status");
--> statement-breakpoint
CREATE INDEX "orders_team_id_index" ON "orders" USING btree ("team_id");
--> statement-breakpoint
...
--> statement-breakpoint
CREATE INDEX "usages_team_id_index" ON "usages" USING btree ("team_id");
--> statement-breakpoint
